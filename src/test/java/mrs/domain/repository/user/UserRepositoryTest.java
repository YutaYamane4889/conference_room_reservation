...
public class UserRepositoryTest {
	...
	public void ユーザー指定で1件返ってくるか検証() {
		List<User> data = repository.findByUserIdLikeOrLastNameLikeOrFirstNameLikeOrderByUserIdAsc("aaaa", "テスト1", "テスト1");
	...
	public void ユーザー名のみ指定で1件返ってくるか検証() {
		List<User> data = repository.findByUserIdLikeOrLastNameLikeOrFirstNameLikeOrderByUserIdAsc("", "テスト1", "");
		assertThat(data.size(), is(1));
	}

	@Test
	public void ユーザー姓のみ指定で1件返ってくるか検証() {
		List<User> data = repository.findByUserIdLikeOrLastNameLikeOrFirstNameLikeOrderByUserIdAsc("", "", "テスト1");
		assertThat(data.size(), is(1));
	}
	...
	@Test
	public void ユーザーIDのみ指定で1件正しく返ってくるか検証() {
		List<User> data = repository.findByUserIdLikeOrLastNameLikeOrFirstNameLikeOrderByUserIdAsc("aaaa","","");
		assertThat(data.get(0).getUserId(),is("aaaa"));
		assertThat(data.get(0).getLastName(),is("テスト1"));
		assertThat(data.get(0).getFirstName(),is("テスト1"));
	}
	...
	@Test
	public void ユーザー姓のみ指定で1件正しく返ってくるか検証() {
		List<User> data = repository.findByUserIdLikeOrLastNameLikeOrFirstNameLikeOrderByUserIdAsc("","","テスト1");
		assertThat(data.get(0).getUserId(),is("aaaa"));
		assertThat(data.get(0).getLastName(),is("テスト1"));
		assertThat(data.get(0).getFirstName(),is("テスト1"));
	...
	public void ユーザー名あいまい検索のみ指定で1件正しく返ってくるか検証() {
		List<User> data = repository.findByUserIdLikeOrLastNameLikeOrFirstNameLikeOrderByUserIdAsc("%a%","","");
		assertThat(data.get(0).getUserId(),is("aaaa"));
		assertThat(data.get(0).getLastName(),is("テスト1"));
		assertThat(data.get(0).getFirstName(),is("テスト1"));
	}
	...
	public void ユーザーIDが昇順で正しく返ってくるか検証() {
		List<User> data = repository.findByUserIdLikeOrLastNameLikeOrFirstNameLikeOrderByUserIdAsc("","%テスト%","");
		assertThat(data.get(0).getUserId(),is("aaaa"));
